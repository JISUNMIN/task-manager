...
const TaskItem = ({
  ...
  const content = (
    <div
      className={cn(
        "rounded-lg border border-[var(--border)] bg-[var(--box-bg)] p-3 shadow-[0_1px_3px_rgba(0,0,0,0.08)] dark:border-[var(--border-strong)] dark:bg-[var(--surface-3)] dark:shadow-[0_1px_3px_rgba(0,0,0,0.25)]",
